...
def get_precision_recall(besttau, mean, cov, errors, args, score, label, num_samples, beta=1.0, sampling=None, predicted_score=None):
    '''
    :param args:
    ...
    threshold = np.percentile(th, besttau)
    # τ = th[f1 == maxf1]
