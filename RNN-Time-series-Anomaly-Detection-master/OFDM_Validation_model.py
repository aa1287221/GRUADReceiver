    ...
    for x in range(total_epochs - valid_epochs):
        ...
        for correct_data_check in range(100):
            ...
            if len(datacheck) > 1:
                break
        generate_dataset()
        NO_PREPROCESS_OFDM_RX = np.copy(OFDM_RX)
        NO_PREPROCESS_OFDM_RX = removeCP(NO_PREPROCESS_OFDM_RX)
        ORIGIN_BER = OFDM_Receiver(NO_PREPROCESS_OFDM_RX, Hest, bits)
        ...
        BER = OFDM_Receiver(Unknown_OFDM_RX_noCP, Hest, bits)
        ...
        avg_origin_BER = (total_origin_BER / valid_epochs)
        ...
        if valid_epochs % 1 == 0:
            ...
            print('origin BER:', avg_origin_BER)
